...
const recentDonations = [
  ...
  { 
    ...
    location: "Kuwait", 
    timeAgo: "20 minutes",
    avatar: "https://cdn.dnaindia.com/dims4/default/3ad2aab/2147483647/strip/true/crop/2048x1352+0+0/resize/1200x792!/quality/75/?url=https%3A%2F%2Fcalifornia-times-brightspot.s3.amazonaws.com%2Fd9%2F04%2F312a0e48451c21134bfb72f530b3%2Fla-fg-kenya-refugees-20160506-001"
  },
  { 
    amount: 300, 
    name: "Aisha", 
                    ...
                    <div key={step} className="flex items-center">
                      ...
                      {step === 1 && (
                        <div className="h-1 w-24 mx-2
                          ${calculatorStep > 1 ? 'bg-emerald-500' : 'bg-gray-200'}
                          transition-all duration-300
                        " />
                      )}
                    </div>
                ...
                <div className={`transition-all duration-300 transform ${calculatorStep === 1 ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 absolute'}`}>
                  <div className="space-y-6">
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <input
                            ...
                            className="p-3 md:p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm w-full"
                          />
                        </div>
                      </div>
                    ))}
                    ...
                    <button
                      ...
                      className="w-full bg-emerald-500 text-white py-4 px-6 rounded-xl hover:bg-emerald-700 transition-colors duration-300 flex items-center justify-center gap-3 mt-8"
                    >
                  ...
                  <div>
                    ...
                    <div className="flex gap-4 mt-8">
                      ...
                      <button
                        ...
                        className="flex-1 bg-emerald-500 text-white py-4 px-6 rounded-xl hover:bg-emerald-700 transition-colors duration-300"
                      >
                        Calculate
                      </button>
                    </div>
            ...
            <div className="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full animate-modal-up">
              ...
              <div className="relative h-32 bg-gradient-to-r from-emerald-600 to-emerald-400 p-6">
                ...
                <div className="absolute -bottom-8 left-6 w-16 h-16 rounded-full bg-white shadow-lg flex items-center justify-center">
                  ...
                  {donationModal.type === 'emergency' && <Home className="w-8 h-8 text-emerald-600" />}
                  {donationModal.type === 'general' && <HandHeart className="w-8 h-8 text-emerald-600" />}
                </div>
              </div>
              ...
              <div className="px-6 pt-12 pb-6">
                <h3 className="text-2xl font-bold text-emerald-900 mb-2">
                  {donationModal.type === 'education' ? 'Support Education' : 
                   ...
                   donationModal.type === 'emergency' ? 'Emergency Relief' :
                   'General Donation'}
                </h3>
                <p className="text-slate-600 mb-6">
                  {donationModal.type === 'education' ? 'Help provide quality education to children in need' :
                   ...
                   donationModal.type === 'emergency' ? 'Provide emergency assistance to those affected by crisis' :
                   'Your donation will be used to support various causes'}
                </p>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          placeholder="0.00"
                          className="p-3 md:p-4 border-2 border-emerald-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all w-full"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-emerald-50 p-6 rounded-xl space-y-4 animate-scaleIn">
                        ...
                        <div className="space-y-4">
                          ...
                          {donationModal.type === 'emergency' && (
                            <>
                              <p className="text-emerald-800 animate-slideInLeft">Your donation will help provide:</p>
                              <ul className="space-y-3">
                                <li className="flex items-center text-slate-700">
                                  <Home className="w-5 h-5 text-emerald-600 mr-2" />
                                  <span>Emergency shelter for {Math.floor(Number(donationModal.amount) / 50)} families</span>
                                </li>
                                <li className="flex items-center text-slate-700">
                                  <Users className="w-5 h-5 text-emerald-600 mr-2" />
                                  <span>Support for {Math.floor(Number(donationModal.amount) / 100)} people</span>
                                </li>
                              </ul>
                            </>
                          )}
                          {donationModal.type === 'general' && (
                            <>
                              <p className="text-emerald-800 animate-slideInLeft">Your donation will help support various causes</p>
                            </>
                          )}
                        </div>
                      </div>
      ...
      <section id="donate" className="py-20 bg-gradient-to-b from-emerald-100 to-white overflow-x-hidden">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <button
              onClick={() => setShowCalculator(true)}
              className="flex items-center justify-center px-8 py-4 bg-white border-2 border-emerald-600 text-emerald-600 rounded-xl hover:bg-emerald-50 transition-colors duration-300"
            >
